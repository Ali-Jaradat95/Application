...
{
    public class MadfoatcomResponseRepositoryTests : ApplicationEntityFrameworkCoreTestBase
    {
        private readonly IMadfoatcomResponseRepository _madfoatcomResponseRepository;

        public MadfoatcomResponseRepositoryTests()
        {
            _madfoatcomResponseRepository = GetRequiredService<IMadfoatcomResponseRepository>();
        }
        ...
        public async Task GetListAsync()
        {
            ...
            {
                // Act
                var result = await _madfoatcomResponseRepository.GetListAsync(
        ...
        public async Task GetCountAsync()
        {
            ...
            {
                // Act
                var result = await _madfoatcomResponseRepository.GetCountAsync(

...
{
    public class OrangeBillPullServiceConfigurationRepositoryTests : ApplicationEntityFrameworkCoreTestBase
    {
        private readonly IOrangeBillPullServiceConfigurationRepository _orangeBillPullServiceConfigurationRepository;

        public OrangeBillPullServiceConfigurationRepositoryTests()
        {
            _orangeBillPullServiceConfigurationRepository = GetRequiredService<IOrangeBillPullServiceConfigurationRepository>();
        }
        ...
        public async Task GetListAsync()
        {
            ...
            {
                // Act
                var result = await _orangeBillPullServiceConfigurationRepository.GetListAsync(
        ...
        public async Task GetCountAsync()
        {
            ...
            {
                // Act
                var result = await _orangeBillPullServiceConfigurationRepository.GetCountAsync(
                    isServiceEnabled: true,
                    isWebServiceEnabled: true,

...
{
    public class ServiceTypeLookupRepositoryTests : ApplicationEntityFrameworkCoreTestBase
    {
        private readonly IServiceTypeLookupRepository _serviceTypeLookupRepository;

        public ServiceTypeLookupRepositoryTests()
        {
            _serviceTypeLookupRepository = GetRequiredService<IServiceTypeLookupRepository>();
        }
        ...
        public async Task GetListAsync()
        {
            ...
            {
                // Act
                var result = await _serviceTypeLookupRepository.GetListAsync(
        ...
        public async Task GetCountAsync()
        {
            ...
            {
                // Act
                var result = await _serviceTypeLookupRepository.GetCountAsync(

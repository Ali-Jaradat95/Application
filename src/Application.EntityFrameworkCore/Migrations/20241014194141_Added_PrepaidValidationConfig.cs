...
{
    /// <inheritdoc />
    public partial class Added_PrepaidValidationConfig : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppAccessChannelLookup", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppApiRequestResponseLog", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppBillingStatusLookup", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppBillStatusLookup", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppBillTypeLookup", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppCharSetLookup", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppEmailRecipientSendingStatusLookup", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppLanguageIsoNameLookup", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BillingNo = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    BillNo = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ServiceType = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    PrepaidCat = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    DueAmt = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
                    ValidationCode = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    JOEBPPSTrx = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    BankTrxId = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    BankCode = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    PmtStatus = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    PaidAmt = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
                    FeesAmt = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
                    FeesOnBiller = table.Column<bool>(type: "bit", nullable: false),
                    ...
                    AccessChannel = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    PaymentMethod = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    PaymentType = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Amount = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
                    SetBnkCode = table.Column<int>(type: "int", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppMadfoatcomRequest", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DeleterId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    DeletionTime = table.Column<DateTime>(type: "datetime2", nullable: true),
                    BillerCode = table.Column<int>(type: "int", nullable: true),
                    BillingNo = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    BillNo = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    DueAmt = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ValidationCode = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ServiceType = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    PrepaidCat = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ...
                    ReceivingCountry = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ...
                    AllowPart = table.Column<bool>(type: "bit", nullable: false),
                    Upper = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Lower = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    BillsCount = table.Column<int>(type: "int", nullable: true),
                    JOEBPPSTrx = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ProcessDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    STMTDate = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppMadfoatcomResponse", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppMessageEncodingLookup", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppMethodTypeLookup", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppOperationTypeLookup", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppOrangeBillPaymentNotificationConfiguration", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsServiceEnabled = table.Column<bool>(type: "bit", nullable: false),
                    IsWebServiceEnabled = table.Column<bool>(type: "bit", nullable: false),
                    WebServiceUrl = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ...
                    ConnectionStringUserId = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ConnectionStringPassword = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ConnectionStringDataSource = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ...
                    YearlyLimit = table.Column<int>(type: "int", nullable: true),
                    ErrorMessage = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppOrangeBillPullServiceConfiguration", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppPaymentCurrencyLookup", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppPaymentMethodLookup", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppPaymentSourceLookup", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppPaymentStatusLookup", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppPaymentTypeLookup", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppPrepaidCategoryLookup", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AliasBillingName = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    IsTesting = table.Column<bool>(type: "bit", nullable: false),
                    EndpointUrl = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppPrepaidValidationConfig", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppProcessStatusLookup", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppServiceTypeLookup", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppSeverityLookup", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppThresholdLookup", x => x.Id);
                });
        }

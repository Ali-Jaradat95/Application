...
{
    public abstract class GetOrangeBillPullServiceConfigurationsInputBase : PagedAndSortedResultRequestDto
    {
        ...
        public GetOrangeBillPullServiceConfigurationsInputBase()
        {
